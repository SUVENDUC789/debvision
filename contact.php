...
<html lang="en">
    <head>
        ...
        <title>Contact - Debvision International</title>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Contact Me</h1>
                            <h2>Ph : 9051268110 / 7003238851</h2>
                            <h2>Email : debashisc72@gmail.com</h2>
                            <span class="text-type" data-wait="3000"
                    ...
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="my-5">
                            ...
                            <form action="Submit.php" method="post">
                                ...
                                <div class="form-floating">
                                    <input class="form-control" id="phone" name="phone" required  type="tel" placeholder="Enter your phone number..." data-sb-validations="required" />
